...
module.exports = {
  ...
  UFMUL: function (a, b, N, runState) {
    var base10 = new BN('1010', 2)
    var c = a.mul(b).div(base10.pow(N))
    if (!InU256(c)) {
      trap(ERROR.OVERFLOW_ERROR)
    }
    return c
  },
  SFMUL: function (a, b, N, runState) {
    a = a.fromTwos(256)
    b = b.fromTwos(256)
    N = N.fromTwos(256)
    var base10 = new BN('1010', 2)
  ...
  UFDIV: function (a, b, N, runState) {
    var base10 = new BN('1010', 2)
    var c = a.mul(base10.pow(N)).div(b)
    if (!InU256(c)) {
      trap(ERROR.OVERFLOW_ERROR)
    }
    return c
  },
  SFDIV: function (a, b, N, runState) {
    a = a.fromTwos(256)
    b = b.fromTwos(256)
    N = N.fromTwos(256)
    var base10 = new BN('1010', 2)
  ...
  ISVALIDATOR: function (address, runState) {
    var isValidator = false
    var validators = runState.validators
